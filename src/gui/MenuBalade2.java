...
public class MenuBalade2 extends JPanel implements ActionListener 
{
	...
	public MenuBalade2(JFrame f, Connection connect) {
		...
		modifierBaladeButton.addActionListener(new modifierBaladeButtonListener(f));
		supprimerBaladeButton.addActionListener(new supprimerBaladeButtonListener(f));
